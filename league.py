    ...
    while True:
        try:
            ...
            if process_name in output:
                ...
                time.sleep(10)
                lobby(region, riot_api, client_api)
            else:
...
def lobby(region, riot_api, client_api):
    ...
    while True:
        ...
        chatlog = client_api + '/chat/v5/messages/champ-select'
        response = requests.get(chatlog, verify=False)
        chatlog_json = json.loads(response.text)
